--para crearlas en el schema que es 
SET search_path TO adminSpace;

-- Muestra el search_path completo (orden de búsqueda de esquemas)
SHOW search_path;

-- Muestra solo el esquema actual (el primer esquema del search_path donde se crearán los objetos)
